    ...
    static applyTransformations(webPackage, parameters, packageType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (parameters) {
                ...
                var folderPath = yield deployUtility.generateTemporaryFolderForDeployment(isFolderBasedDeployment, webPackage, packageType);
                if (parameters) {
                    tl.debug('parsing web.config parameters');
                    var webConfigParameters = (0, ParameterParserUtility_1.parse)(parameters);
